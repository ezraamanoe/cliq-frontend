...
import { Select, SelectContent, SelectGroup, SelectLabel, SelectTrigger, SelectValue, SelectItem } from "@/components/components/ui/select"
...
type FilterType = "location" | "date" | "price" | "type"
...
export function Filters({ filters, selectedCategory }: FiltersProps) {
            ...
            <Button variant="secondary" size="sm" className="flex items-center gap-2">
              ...
              {range[0] === 0 && range[1] === 100 ? (
                ...
                <>
                  ...
                  <span>
                    {range[1] === 100 ? "ANY AMOUNT" : `£${range[1]}`}
                  </span>
                </>
              )}
            </Button>
